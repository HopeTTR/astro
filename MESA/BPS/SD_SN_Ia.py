...
runs_path = (
    "/home/IITB/CompnalAstrphyNRelvity/23n0315/MESA/mesa-24.08.1/binary_pop/BPS/runs/SD_SN_Ia"
)
...
with open("MC_SD_SN_Ia.json", "w") as f:
    json.dump(
